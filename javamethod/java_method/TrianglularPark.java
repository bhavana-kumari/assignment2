...
public class TrianglularPark{

    // Method to calculate number of rounds
    public static double calculateRounds(double side1, double side2, double side3, double distanceInMeters) {
        double perimeter = side1 + side2 + side3;   // Perimeter of the triangle
        return distanceInMeters / perimeter;       // Rounds = Distance / Perimeter
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The athlete must complete " + Math.ceil(rounds) + " rounds to cover 5 km run.");
